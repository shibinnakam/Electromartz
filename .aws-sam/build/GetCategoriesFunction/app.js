...
window.redirectToRazorpay = async () => {
    ...
    const isProfileComplete = userProfile.name && userProfile.phone_number && userProfile.address;
    if (!isProfileComplete) {
        alert("Please complete your shipping profile before payment.");
        openDashboard();
...
document.getElementById('profile-form')?.addEventListener('submit', async (e) => {
    ...
    const attributes = [
        ...
        { Name: 'address', Value: document.getElementById('p-address-field').value },
        { Name: 'custom:pincode', Value: document.getElementById('p-pincode-field').value },
        { Name: 'custom:landmark', Value: document.getElementById('p-landmark-field').value }
    ];
